...
import com.example.androidbarberstaffapp.Interface.INotificationListener;
...
public class NotificationActivity extends AppCompatActivity implements INotificationListener {

    @BindView(R.id.recycler_notifcation)
            ...
            notificationCollection.orderBy("serverTimestamp", Query.Direction.DESCENDING)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            iNotificationListener.onNotificationLoadFailed(e.getMessage());
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful())
                            {
                                if (task.isSuccessful())
                                {
                                   ...
                                   iNotificationListener.onNotificationLoadSuccess(myNotifications,finalDoc);
                                }
                            }
                        }
                    });
